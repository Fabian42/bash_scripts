...
tagesschau(){
 ...
 while sleep 60; do
  ...
  if [[ "$new_time" != "$old_time" ]]; then
   ...
   if [[ "$title" = "Ende des Liveblogs" || "$title" = "Ende des heutigen Liveblogs" ]]; then return; fi
  fi
 done
}
